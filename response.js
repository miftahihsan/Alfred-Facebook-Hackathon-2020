...
class Response{
    ...
    static genAttachmentReply(){
        ...
        console.log("HELLLLLOOOOOOOOOOOOOOOOOOOOOOOWOOOOOOOOOOOOOOOOOOOOOOWOWOWOWOWOOOOOOOOOOOOOOOOOOOOOOOOOWOWOWOWOWOOOOOOOOOOOOOOOOOOOOOOOO" + response['attachment']);
        console.log("HELLLLLOOOOOOOOOOOOOOOOOOOOOOOWOOOOOOOOOOOOOOOOOOOOOOWOWOWOWOWOOOOOOOOOOOOOOOOOOOOOOOOOWOWOWOWOWOOOOOOOOOOOOOOOOOOOOOOOO" + response['attachment']['type']);
        console.log("HELLLLLOOOOOOOOOOOOOOOOOOOOOOOWOOOOOOOOOOOOOOOOOOOOOOWOWOWOWOWOOOOOOOOOOOOOOOOOOOOOOOOOWOWOWOWOWOOOOOOOOOOOOOOOOOOOOOOOO" + response['attachment']['payload']['attachment_id']);
        return response;
    }
